...
//		absolutePanel.add(changeservieproviderCheckBox, 40, 191);
		...
		okButton.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				// TODO Auto-generated method stub
				if(textBox.getValue()!=null&&!textBox.getValue().equals("")&&isTypelegal(textBox3.getValue(), "Integer")){
...
//		System.out.println(minutes.length+"  "+hours.length+"  "+times.length);
	 ...
	 */
	public NonFixedFor(String labelText, DiagramBuilderExample d,Panel_Overview overview) {
    	this.overview=overview;
		dbe = d;
