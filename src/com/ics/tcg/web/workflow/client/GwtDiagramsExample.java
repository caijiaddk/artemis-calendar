...
import com.ics.tcg.web.workflow.client.examples.AbstractConnectionsExample;
...
public class GwtDiagramsExample extends BaseExamplesEntryPoint {
	...
	public DiagramBuilderExample diagramBuilderExample;

	public static boolean isState() {
		return state;
	}

	public GwtDiagramsExample(Panel_Overview panel_Overview) {
	...
	public void onLoad() {
		...
		diagramBuilderExample = new DiagramBuilderExample(this, overview);
