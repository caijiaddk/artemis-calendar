...
public class createDB {
	...
	void insertUser() throws SQLException {
		...
		stmt.executeUpdate("load data local infile 'd:/aa.txt' into table user");
	...
	void insertRecords() throws SQLException {
		stmt.execute("insert into records values(1,1,1,"+null+",5,1," + true + ",1)");
		stmt.execute("insert into records values('2',1,'1',"+null+",5,2," + true
				+ ",1)");
		stmt.execute("insert into records values('3',1,'1',"+null+",5,3," + true
				+ ",1)");
		stmt.execute("insert into records values('4',1,'2',"+null+",5,1," + false
				+ ",1)");
		stmt.execute("insert into records values('5',1,'2',"+null+",5,2," + false
				+ ",1)");
		stmt.execute("insert into records values('6',1,'2',"+null+",5,3," + true
				+ ",1)");
	}
